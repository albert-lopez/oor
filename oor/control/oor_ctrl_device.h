...
extern ctrl_dev_class_t mr_ctrl_class;
...
int notify_datap_rm_fwd_from_entry(oor_ctrl_dev_t *dev, lisp_addr_t *eid_prefix, uint8_t is_local);
int notify_datap_reset_all_fwd(oor_ctrl_dev_t *dev);
